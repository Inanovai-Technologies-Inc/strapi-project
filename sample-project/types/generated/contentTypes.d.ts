...
export interface ApiCareerCareer extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    erpnextName: Schema.Attribute.String &
      Schema.Attribute.SetPluginOptions<{
        i18n: {
          localized: true;
        };
...
export interface ApiNewNew extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    MoreInformation: Schema.Attribute.Text &
      Schema.Attribute.SetPluginOptions<{
        i18n: {
          localized: true;
        };
    ...
    publishedAt: Schema.Attribute.DateTime;
    slug: Schema.Attribute.UID<'NewsTitle'>;
    updatedAt: Schema.Attribute.DateTime;
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
  };
...
export interface ApiProductProduct extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    certificationLogos: Schema.Attribute.Media<
...
export interface ApiSitetextSitetext extends Struct.SingleTypeSchema {
  ...
  info: {
    ...
    pluralName: 'sitetexts';
    singularName: 'sitetext';
  };
  options: {
    draftAndPublish: true;
  };
...
export interface ApiTechnicalDocumentTechnicalDocument
  extends Struct.CollectionTypeSchema {
  collectionName: 'technical_documents';
  info: {
    displayName: 'Technical-Document';
    pluralName: 'technical-documents';
    singularName: 'technical-document';
  };
  options: {
    draftAndPublish: true;
  };
  ...
  attributes: {
    ...
    language: Schema.Attribute.Enumeration<
      ['English', 'German', 'French', 'Spanish', 'Italian', 'Other']
    > &
      Schema.Attribute.SetPluginOptions<{
        i18n: {
          localized: true;
    ...
    localizations: Schema.Attribute.Relation<
      'oneToMany',
      'api::technical-document.technical-document'
    >;
